...
namespace KarmaWebMVC.Areas.Admin
{
    [Area("Admin")]
    public class ProductsController : Controller
    {
        ...
        public ProductsController(KarmaWebMVCContext context)
        {
            _context = context;
        }
        ...
        {
            var karmaWebMVCContext = _context.Product.Include(p => p.Brand).Include(p => p.Category).Include(p => p.Size);
        ...
        public async Task<IActionResult> Create([Bind("ProductId,ProductName,ProductDescription,ProductPrice,ProductQuantity,ProductImage,CategoryId,BrandId,SizeId,Status,AddedDate")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProductId,ProductName,ProductDescription,ProductPrice,ProductQuantity,ProductImage,CategoryId,BrandId,SizeId,Status,AddedDate")] Product product)
        {
